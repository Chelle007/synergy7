...
public class Data {
    ...
    public static final User customer = new User(0, "Customer", "Customer@gmail.com", "12345678", User.Role.CUSTOMER);
    public static final User seller = new User(1, "Seller", "Seller@gmail.com", "12345678", User.Role.SELLER);
    public static final Restaurant restaurant = new Restaurant(0, "BinarResto", "Singapore", true, seller);
