...
public class Main {
    ...
    public static String colorOfPrice = "tosca";
    public static String colorOfQty = "blue";
    public static String colorOfError = "red";
    ...
    public static void mainMenu() {
        ...
        for (int i = 0; i<menu.size(); i++) {
            ...
            System.out.printf(
                    ...
                    (i+1),
                    menuItem.getName(),
                    formatColor(formatPrice(menuItem.getPrice()), colorOfPrice));
        }
        ...
        while (true) {
            ...
            if (choice == 0) {
                ...
                if (orders.isEmpty()) {
                    printlnColor("Anda belum memesan apa pun.", colorOfError);
                } else {
                    totalMenu();
                    break;
                }
            } else {
                printlnColor("Pilihan tidak valid.", colorOfError);
            }
        }
    }
    ...
    public static void quantityMenu(int choice) {
        ...
        System.out.printf(
                ...
                formatColor(formatPrice(selectedMenuItem.getPrice()), colorOfPrice));
        ...
        while (true) {
            ...
            if (qty == 0) {
                ...
                printlnColor("Mohon input angka positif.", colorOfError);
            }
        }
    ...
    public static void receiptMenu() {
        ...
        try {
            ...
            printlnColor("Eror saat menghasilkan struk dalam file text.", colorOfError);
        }
    }

    public static void confirmationMenu() {
        System.out.println(formatBarrier("Mohon masukkan input\npilihan Anda"));
        System.out.println("(Y) untuk lanjut");
        System.out.println("(N) untuk keluar");
        String ans = checkString("=> ", new String[]{"Y", "y", "N", "n"});
    ...
    public static int checkInt(String question) {
        while (true) {
            ...
            try {
                ...
                printlnColor("Eror. Mohon input angka dengan benar.", colorOfError);
                input.reset();
                input.nextLine();
            }
        }
    ...
    public static String checkString(String question, String[] choices) {
        while (true) {
            System.out.print(question);
            ...
            printlnColor("Mohon masukkan input sesuai pilihan.", colorOfError);
        }
    }
    ...
    public static String returnTotalOrder(boolean withColor) {
        ...
        for (Order order : orders) {
            ...
            output.append(String.format(
                    ...
                    menuItem.getName(),
                    withColor ? formatColor(qty, colorOfQty) : qty,
                    withColor ? formatColor(formatPrice(price), colorOfPrice) : formatPrice(price)
            ));
        }
        ...
        output.append(String.format(
                withColor ? "%-15s %-16s %s%n" : "%-15s %-7s %s%n",
                "Total ",
                withColor ? formatColor(Integer.toString(totalQty), colorOfQty) : Integer.toString(totalQty),
                withColor ? formatColor(formatPrice(totalPrice), colorOfPrice) : formatPrice(totalPrice)
        ));
